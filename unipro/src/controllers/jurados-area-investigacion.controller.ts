...
export class JuradosAreaInvestigacionController {
  ...
  async find(
    ...
    return this.juradosRepository.JuradosInvestigacion(id).find(filter);
  }
  ...
  async create(
    ...
    return this.juradosRepository.JuradosInvestigacion(id).create(areaInvestigacion);
  }
  ...
  async patch(
    ...
    return this.juradosRepository.JuradosInvestigacion(id).patch(areaInvestigacion, where);
  }
  ...
  async delete(
    ...
    return this.juradosRepository.JuradosInvestigacion(id).delete(where);
  }
}
