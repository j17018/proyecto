...
export class FacultadDepartamentoController {
  ...
  async find(
    ...
    return this.facultadRepository.tiene(id).find(filter);
  }
  ...
  async create(
    ...
    return this.facultadRepository.tiene(id).create(departamento);
  }
  ...
  async patch(
    ...
    return this.facultadRepository.tiene(id).patch(departamento, where);
  }
  ...
  async delete(
    ...
    return this.facultadRepository.tiene(id).delete(where);
  }
}
