...
export class TipoSolicitudSolicitudController {
  ...
  async get(
    ...
    return this.tipoSolicitudRepository.solicitudes_id_fk(id).get(filter);
  }
  ...
  async create(
    ...
    return this.tipoSolicitudRepository.solicitudes_id_fk(id).create(solicitud);
  }
  ...
  async patch(
    ...
    return this.tipoSolicitudRepository.solicitudes_id_fk(id).patch(solicitud, where);
  }
  ...
  async delete(
    ...
    return this.tipoSolicitudRepository.solicitudes_id_fk(id).delete(where);
  }
}
