...
export class ModalidadSolicitudController {
  ...
  async get(
    ...
    return this.modalidadRepository.id_modalidad_fk(id).get(filter);
  }
  ...
  async create(
    ...
    return this.modalidadRepository.id_modalidad_fk(id).create(solicitud);
  }
  ...
  async patch(
    ...
    return this.modalidadRepository.id_modalidad_fk(id).patch(solicitud, where);
  }
  ...
  async delete(
    ...
    return this.modalidadRepository.id_modalidad_fk(id).delete(where);
  }
}
