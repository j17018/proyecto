...
export class JuradosAreaInvestigacionController {
  ...
  async find(
    ...
    return this.juradosRepository.jurado_investigacion_relacion(id).find(filter);
  }
  ...
  async create(
    ...
    return this.juradosRepository.jurado_investigacion_relacion(id).create(areaInvestigacion);
  }
  ...
  async patch(
    ...
    return this.juradosRepository.jurado_investigacion_relacion(id).patch(areaInvestigacion, where);
  }
  ...
  async delete(
    ...
    return this.juradosRepository.jurado_investigacion_relacion(id).delete(where);
  }
}
