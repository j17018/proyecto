...
export class JuradosInvestigacionController {
  ...
  @get('/jurados-investigaciones/{id}')
  @response(200, {
    description: 'JuradosInvestigacion model instance',
    content: {
      'application/json': {
  ...
  @patch('/jurados-investigaciones/{id}')
  @response(204, {
  ...
  @put('/jurados-investigaciones/{id}')
  @response(204, {
  ...
  @del('/jurados-investigaciones/{id}')
  @response(204, {
